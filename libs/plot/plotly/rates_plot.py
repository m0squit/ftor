...
class RatesPlot(_Plot):
    ...
    def _add_21(cls):
        ...
        trace_1 = cls._create_trace('жид_ftor', x, devs_rate_liq, mode='lines+markers', marker_size=3, visible='legendonly')
        trace_2 = cls._create_trace('неф_ftor', x, devs_rate_oil_model, mode='lines+markers', marker_size=3)
        trace_3 = cls._create_trace('неф_ксг', x, devs_rate_oil_ksg, mode='lines+markers', marker_size=3)
    ...
    def _add_22(cls):
        ...
        devs_rel_cum_liq = df_test_day['dev_cum_liq_model'].to_list()
        devs_rel_cum_oil_model = df_test_day['dev_cum_oil_model'].to_list()
        devs_rel_cum_oil_ksg = df_test_day['dev_cum_oil_ksg'].to_list()
